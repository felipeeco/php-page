...
<div class="box-bar-desk box-bar d-sm-none hide-msg-panel">
	<div class="container">
		<div class="row">
			...
			if (!empty($user_id)) {
			?>
			<div class="col-3"><a href="<?php echo base_url('/profile'); ?>" class="link"><i class="fa-light fa-user"></i><span class="text">Hjem</span></a></div>
			<?php } else { ?>
			<div class="col-3"><a href="<?php echo base_url('innlogging'); ?>" class="link"><i class="fa-light fa-user"></i><span class="text">Logg inn</span></a></div>
			<?php } ?>
			<div class="col-3"><a href="<?php echo base_url('jobbannonse'); ?>" class="link"><i class="fa-light fa-circle-plus"></i><span class="text">Legg ut oppdrag</span></a></div>
			<div class="col-3"><a href="<?php echo base_url('messages'); ?>" class="link"><i class="fa-light fa-comment"></i><span class="text">Meldinger<span class="notification-num"></span></span></a></div>
			<div class="col-3"><a href="<?php echo base_url('finn'); ?>" class="link <?php if ($method == 'index' and $controller == 'browse') {
																							echo 'active';
																						} ?>"><i class="fa-light fa-magnifying-glass"></i><span class="text">Søk</span></a></div></div>
	</div>
</div>
<?php } ?>
 <!--------- footer menu ----------->
