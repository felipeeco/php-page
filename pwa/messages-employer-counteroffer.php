                        ...
                        <div class=" contract-info">
                            ...
                            <div class="counter-offer-content">
                                ...
                                <div class="d-flex g-10">
                                    <a href="#" class="btn btn-outline-danger"><i class="fas fa-ban"></i> Reject offer</a>
                                    <a href="#" class="btn btn-secondary"> Open contact</a>
                                </div>
                            </div>
                        </div>
                    </div>
				...
				<div>
					<div class="footer-btn mobile-footer-btn">
						...
						<div class="dropdown-menu" id="footer-dropdown" x-placement="bottom-start" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(38px, 40px, 0px);">
							...
							<button type="button" class="btn_readContract" data-content="comming" data-toggle="modal" data-target="#reportUserModal">Report User  <i class="fal fa-exclamation-circle" aria-hidden="true"></i></button>
