...
<!-- Chat content -->  
				...
				<div>
					<div class="footer-btn mobile-footer-btn">
						...
						<div class="dropdown-menu" id="footer-dropdown" x-placement="top-start" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(175px, -169px, 0px);">
							...
							<button type="button" class="btn_readContract" >Contract <i class="fal fa-file-signature" aria-hidden="true"></i></button>
	...
	<script>
				...
				steps: [
					{
						element: "#footer-menu-dropdown",
						content: "Du må få jobben før kontaktinformasjon deles men det er gode hjelpemidler under “+” ikonet i chatten",
						placement: "top",
						smartPlacement: true,
						backdrop: true,
						backdropPadding: 10,
					...
					}, 
					{
						...
						content: "Om dere er enig om å være uening, fjerner du oppdragsgiver her. Bruker du Vipps blir reservert gebyr vendligvis frigitt med en gang",
						placement: "top",
						smartPlacement: true,
						backdrop: true,
						backdropPadding: 10,
					...
					},
					{
						...
						content: "Om kommunikasjon er ufin eller ikke hører hjemme, rapporterer du oppdragsgiver her",
						placement: "top",
						smartPlacement: true,
						backdrop: true,
						backdropPadding: 10,
					...
					},
					{
						...
						content: "Avtale om direkte kontakt eller befaring er ikke tillatt i chatten og må avtales her",
						placement: "top",
						smartPlacement: true,
						backdrop: true,
						backdropPadding: 10,
					...
					{
						content: "Kontaktinformasjon i chatten resulterer i forpliktende avtaler og er strengt forbudt. Våre chattregler finner du til enhver tid øverst i chatten",
						orphan: true,
						smartPlacement: true,
						backdrop: true,
						backdropContainer: 'body',
