...
<!-- END MODAL CONTENT SAMPLE -->
	<!-- end rating modals -->
	<div class="landing nopic pwa d-flex align-items-end" style="height: calc(100vh - 90px); background: red; padding-bottom: 110px;">
		<div class="holder w-100">
		<div class="container">
			<div class="row">
				<div class="col-12">
					<h2>Velkommen, <?php echo ($userName)?>.</h2>
				</div>
			</div>
			<div class="row">
				<div class="col-6">
					...
					<div class="imageTools">
						<div class="profileImg-form">
							<form action="" method="">
								...
								<button class="btn btn-delete text-center"><i class="fas fa-trash-alt"></i> Delete Picture</button>
...
<div class="member-deals text-center white-bg fixed-bottom w-100 bottom-0 p-4" style="border-radius: 30px 30px 0 0;">
	<div class="container">
		<div class="row">
		  <div class="col-12">
			<div class="collapse show multi-collapse" id="multiCollapseExample1">
			  <div class="">
				...
				<p class="m-0 lead" type="button" data-toggle="collapse" data-target=".multi-collapse" aria-expanded="false" aria-controls="multiCollapseExample1 multiCollapseExample2"><i class="fa-solid fa-tag green "></i> Click for member deals</p>
			...
			<div class="collapse multi-collapse" id="multiCollapseExample2">
			  <div class="w-100">
				<i class="fa-solid fa-angle-down icon-xl w-100" style="color: var(--secondary-light)" type="button" data-toggle="collapse" data-target=".multi-collapse" aria-expanded="true" aria-controls="multiCollapseExample1 multiCollapseExample2"></i>
				 <!--<button class="btn btn-primary" type="button" data-toggle="collapse" data-target=".multi-collapse" aria-expanded="true" aria-controls="multiCollapseExample1 multiCollapseExample2">Close</button>	-->
