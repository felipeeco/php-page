<!--Default-->
<div class="modal fade" id="award-accept-total">
		...
		<div class="modal-content">	
			...
			<div class="modal-body grey-bg pt-0 pb-0">
				<p>You are offered the job <strong>#Job title#</strong>. Please check if details is as agreed</p>
					...
					<div class="d-flex align-items-center g-10 mb-3">
						<div class="total-price-col">
							<h6 for="total-price-input" class="m-0">Agreed total price</h6>
							<span class="d-inline-block job-price white-bg mb-2 mt-2 p-2 rounded">150.-</span>
						</div>
					</div>
